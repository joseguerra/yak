...
export class ProductService {
  ...
  editProduct(key, data: Product) {
    ...
    this.toastrService.wait("Perfecto", "Producto Actualizada");
    return this.products;
  }
  ...
  deleteProduct(key: string) {
    ...
    this.toastrService.wait("Perfecto", "Producto Eliminado");
  }
  ...
  addFavouriteProduct(data: Product): void {
    ...
    if (favority) {
      ...
      this.toastrService.wait(
        "Producto Agregado",
        "Producto Agregado como Favorito"
      );
      setTimeout(() => {
  ...
  */
  ...
  removeLocalCartProduct(product: Product) {
    ...
    this.toastrService.wait("Perfecto", "Carrito actualizado.");
    // ReAdding the products after remove
